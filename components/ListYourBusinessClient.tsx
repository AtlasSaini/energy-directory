...
export default function ListYourBusinessClient({ categoryCount }: Props) {
  ...
  const FAQS = [
    ...STATIC_FAQS.slice(0, 2),
    {
      q: 'What categories can I list in?',
      a: `We have ${categoryCount} categories across energy and mining — including Exploration & Production, Oil & Gas, Renewables, Solar & Wind, Battery Storage, Carbon & ESG, Power Generation, LNG, Oilsands, Gold Mining, Copper & Base Metals, Uranium, Potash, Lithium & Battery Metals, Mining Services, and more.`,
    },
    ...STATIC_FAQS.slice(2),
  ]
